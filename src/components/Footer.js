    ...
    <>
      <footer>
        <div className="footer max-w-full mx-auto px-4 sm:px-6 bg-gray-100 border-t border-b py-30">
          {/* Top area: Blocks */}
          <div className="flex sm:grid-cols-12 gap-5 py-8 md:py-12 border-t border-gray-200 lg:w-[80%] mx-auto">
            {/* 1st block */}
            <div className="col-span-12 lg:col-span-4">
              <div className="box-border border-b-4 border-blue-900 p-8 bg-gray-200 text-gray-600 text-center rounded-lg xl:w-80 mx-auto">
                <h3 className="font-bold text-4xl mb-4"><img src='./logo.png'></img></h3>
                <div className="text-md font-medium text-gray-600">
                  <p>2016 TURTLE PASS TRL,</p>
                  <p>Fort Worth, TX 76135</p>
                  <p>Tel: +1 254 254 0895</p>
                  <p>steven.reynolds@bprescott.com</p>
                </div>
              </div>
            </div>
